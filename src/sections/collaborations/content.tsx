    ...
    <div>
      <div className="grid grid-cols-1 px-3 py-10 mx-auto lg:grid-cols-2 gap-x-10 max-w-7xl">
        <div className="flex flex-col items-start justify-center ">
          ...
          <p className="pt-4">
            So far, GarbhaGnan has successfully created miracles that include:
          </p>
          <ul className="pt-4 space-y-2 list-disc list-inside">
            <li>
              150+ Free Fertility Screening Camps across the length and breadth
              of Karnataka.
            </li>
            <li>
          ...
          <p className="mt-4">
            ...
            Government organizations can help every couple have a child.{" "}
          </p>
        </div>
